...
const menuItem_entity_1 = require("./menuItem.entity");
...
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", Number)
], ProductOrder.prototype, "menuItemId", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", Number)
], ProductOrder.prototype, "orderId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => menuItem_entity_1.MenuItem, (menuItem) => menuItem.productOrders),
    (0, typeorm_1.JoinColumn)({ name: 'menuItemId' }),
    __metadata("design:type", menuItem_entity_1.MenuItem)
], ProductOrder.prototype, "menuItem", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => order_entity_1.Order, (order) => order.productOrders),
